...
| CVZone | Simplifies computer vision and hand tracking |
...
File names inside the Model/ folder may vary depending on the trained model used.
...
CVZone/MediaPipe detects the user's hand.
The detected hand region is extracted and processed.
The processed image is passed to the trained Keras model.
The model predicts the corresponding sign.
The predicted gesture is displayed in the application window.
🚀 Installation
...
The application will open the webcam and begin detecting supported hand gestures.
...
The collected images can then be used for training a gesture classification model.
...
The model receives processed hand images and predicts the corresponding gesture class.
...
Supporting complete sign language alphabets
...
The model is currently designed for the predefined gestures included in the project.
👨‍💻 Author

Yxminn

GitHub:
https://github.com/Yxminn
